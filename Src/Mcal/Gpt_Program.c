...
*  GLOBAL DATA
*****************************************************************************/
 static const uint32_t Gptm_baseAddress[] = {GPT_TIMER_0_BASE_ADDRESS,
...
void Gptm_Init(Gpt_OneShotOrPerodicCfgType* configurations[]){
	...
	uint32_t rcgctimerValue = (TIMER_0_CLOCK << GPTM_TIMER_0_ID |
	...
	uint32_t rcgcwtimerValue = (WIDE_TIMER_0_CLOCK << GPTM_WIDE_TIMER_0_ID |
